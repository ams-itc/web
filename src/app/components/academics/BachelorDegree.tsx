...
const programs: Record<ProgramKey, Program> = {
  dataScience: {
    ...
    curriculum: {
      year1: {
        semester1: [
          { code: "DTC11ANL", name: { en: "Calculus I", kh: "គណិតវិទ្យាអនុវត្ត ភាគ​ ១" }, credit: 3 },
          { code: "DTC11MCN", name: { en: "Mechanics I", kh: "មេកានិច I" }, credit: 3 },
          { code: "DTC11GEC", name: { en: "Management & Accounting", kh: "ការគ្រប់គ្រង និង គណនេយ្យ" }, credit: 3 },
          { code: "DTC11PHI", name: { en: "Philosophy", kh: "ទស្សនវិទ្យា" }, credit: 2 },
          { code: "DTC11HIS", name: { en: "History", kh: "ប្រវត្តិវិទ្យា" }, credit: 2 },
          { code: "DTC11FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit: 16,
        semester2: [
          { code: "DTC12INF", name: { en: "Introduction to ICT", kh: "ការណែនាំអំពី ICT" }, credit: 2 },
          { code: "DTC12ANL", name: { en: "Calculus II", kh: "គណិតវិទ្យាអនុវត្ត ភាគ​ ២" }, credit: 3 },
          { code: "DTC12TMD", name: { en: "Thermodynamics", kh: "កំដៅវិទ្យា" }, credit: 3 },
          { code: "DTC12MKT", name: { en: "Marketing", kh: "ទីផ្សារ" }, credit: 2 },
          { code: "DTC12TDN", name: { en: "Technical Drawing", kh: "គំនូរ​បច្ចេកទេស" }, credit: 2 },
          { code: "DTC12ENV", name: { en: "Environment", kh: "បរិស្ថាន" }, credit: 2 },
          { code: "DTC12FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit2: 17,
      },
      year2: {
        semester1: [
          { code: "DTC21ANL", name: { en: "Calculus II", kh: "គណិតវិទ្យាអនុវត្ត ភាគ​ ២" }, credit: 3 },
          { code: "DTC21MCN", name: { en: "Mechanics II", kh: "មេកានិច II" }, credit: 3 },
          { code: "DTC21GEC", name: { en: "Management & Accounting", kh: "ការគ្រប់គ្រង និង គណនេយ្យ" }, credit: 3 },
          { code: "DTC21PHI", name: { en: "Philosophy", kh: "ទស្សនវិទ្យា" }, credit: 2 },
          { code: "DTC21HIS", name: { en: "History", kh: "ប្រវត្តិវិទ្យា" }, credit: 2 },
          { code: "DTC21FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit: 16,
        semester2: [
          { code: "DTC22INF", name: { en: "Introduction to ICT", kh: "ការណែនាំអំពី ICT" }, credit: 2 },
          { code: "DTC22ANL", name: { en: "Calculus II", kh: "គណិតវិទ្យាអនុវត្ត ភាគ​ ២" }, credit: 3 },
          { code: "DTC22TMD", name: { en: "Thermodynamics", kh: "កំដៅវិទ្យា" }, credit: 3 },
          { code: "DTC22MKT", name: { en: "Marketing", kh: "ទីផ្សារ" }, credit: 2 },
          { code: "DTC22TDN", name: { en: "Technical Drawing", kh: "គំនូរ​បច្ចេកទេស" }, credit: 2 },
          { code: "DTC22ENV", name: { en: "Environment", kh: "បរិស្ថាន" }, credit: 2 },
          { code: "DTC22FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit2: 17,
      },
      year3: {
        semester1: [
          { code: "DTC31ANL", name: { en: "Calculus I", kh: "គណិតវិទ្យាអនុវត្ត ភាគ​ ១" }, credit: 3 },
          { code: "DTC31MCN", name: { en: "Mechanics I", kh: "មេកានិច I" }, credit: 3 },
          { code: "DTC31GEC", name: { en: "Management & Accounting", kh: "ការគ្រប់គ្រង និង គណនេយ្យ" }, credit: 3 },
          { code: "DTC31PHI", name: { en: "Philosophy", kh: "ទស្សនវិទ្យា" }, credit: 2 },
          { code: "DTC31HIS", name: { en: "History", kh: "ប្រវត្តិវិទ្យា" }, credit: 2 },
          { code: "DTC31FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit: 16,
        semester2: [
          { code: "DTC32INF", name: { en: "Introduction to ICT", kh: "ការណែនាំអំពី ICT" }, credit: 2 },
          { code: "DTC32ANL", name: { en: "Calculus II", kh: "គណិតវិទ្យាអនុវត្ត ភាគ​ ២" }, credit: 3 },
          { code: "DTC32TMD", name: { en: "Thermodynamics", kh: "កំដៅវិទ្យា" }, credit: 3 },
          { code: "DTC32MKT", name: { en: "Marketing", kh: "ទីផ្សារ" }, credit: 2 },
          { code: "DTC32TDN", name: { en: "Technical Drawing", kh: "គំនូរ​បច្ចេកទេស" }, credit: 2 },
          { code: "DTC32ENV", name: { en: "Environment", kh: "បរិស្ថាន" }, credit: 2 },
          { code: "DTC32FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit2: 17,
      },
      year4: {
        semester1: [
          { code: "", name: { en: "", kh: ""}, credit: 0 },
        ],
        totalCredit: 0,
        semester2: [
          { code: "", name: { en: "", kh: ""}, credit: 0 },
  ...
  financialEngineering: {
    ...
    curriculum: {
      ...
      year2: {
        semester1: [
          { code: "DTC11ANL", name: { en: "Calculus I", kh: "គណិតវិទ្យាអនុវត្ត ភាគ ១" }, credit: 3 },
          { code: "DTC11MCN", name: { en: "Mechanics I", kh: "មេកានិច ភាគ ១" }, credit: 3 },
          { code: "DTC11GEC", name: { en: "Management & Accounting", kh: "ការគ្រប់គ្រង និង គណនេយ្យ" }, credit: 3 },
          { code: "DTC11PHI", name: { en: "Philosophy", kh: "ទស្សនវិជ្ជា" }, credit: 2 },
          { code: "DTC11HIS", name: { en: "History", kh: "ប្រវត្តិវិទ្យា" }, credit: 2 },
          { code: "DTC11FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit: 16,
        semester2: [
          { code: "DTC12INF", name: { en: "Introduction to ICT", kh: "ការណែនាំអំពី ICT" }, credit: 2 },
          { code: "DTC12ANL", name: { en: "Calculus II", kh: "គណិតវិទ្យាអនុវត្ត ភាគ ២" }, credit: 3 },
          { code: "DTC12TMD", name: { en: "Thermodynamics", kh: "ធរណីយកម្តៅ" }, credit: 3 },
          { code: "DTC12MKT", name: { en: "Marketing", kh: "ទីផ្សារ" }, credit: 2 },
          { code: "DTC12TDN", name: { en: "Technical Drawing", kh: "គំនូរបច្ចេកទេស" }, credit: 2 },
          { code: "DTC12ENV", name: { en: "Environment", kh: "បរិស្ថាន" }, credit: 2 },
          { code: "DTC12FRA", name: { en: "French", kh: "ភាសាបារាំង" }, credit: 3 },
        ],
        totalCredit2: 17,
    ...
    career_opportunities: [
      {
        ...
        career_path: [
          ...
          {
            title: { en: "Business Intelligence Analyst", kh: "អ្នកវិភាគព័ត៌មានអាជីវកម្ម" },
            description: {
    ...
    learningOutcomes: [
      {
        title: { en: "Computational and Programming Proficiency", kh: "ជំនាញក្នុងការគណនា និងសរសេរកម្មវិធី" },
        learning_description: [
          {
            text: {
      ...
      {
        title: { en: "Analytical and Modeling Skills", kh: "ជំនាញវិភាគ និងម៉ូដែល" },
        learning_description: [
          {
            text: {
      ...
      {
        title: { en: "Engineering and Systems Integration", kh: "វិស្វកម្ម និងការរួមបញ្ចូលប្រព័ន្ធ" },
        learning_description: [
          {
            text: {
      ...
      {
        title: { en: "Ethical and Professional Practice", kh: "សីលធម៌ និងអនុវត្តវិជ្ជាជីវៈ" },
        learning_description: [
          {
            text: {
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-6xl py-6">
                  ...
                  <div className="grid grid-cols-5 py-2 px-4 text-base text-[#3A3B5C] bg-gray-50 row-span-1 items-center rounded-b-xl">
                    <h3 className={`font-bold col-span-4 ${language === "en" ? "font-raleway" : "font-preahvihear"}`}>
                      {language === "en" ? (
                        <>
                          Total Semester 1{" "}
                          <span className="text-[#C41E3A]">{yearLabels[selectedYear]?.[language]}</span>
                        </>
                      ) : (
                        <>
          ...
          {program.career_opportunities.map((opportunity, idx) => (
            <div key={idx} className="space-y-5">
              ...
              <p className="text-[#2E2E2E] font-raleway text-base">
                {renderTextWithFont(
                  language === "en" ? opportunity.description.en : opportunity.description.kh,
                  language,
                  "body"
                )}
              </p>
              ...
              <div>
                <p className={`text-black mb-2 ${language === "en" ? "font-raleway" : "font-preahvihear"}`}>
                  {language === "en"
                ...
                <ul className="list-disc list-inside tracking-wide text-[#2E2E2E] pl-3 space-y-1">
                  {opportunity.career_path.map((career, index) => (
                    <li key={index}>
                      {renderTextWithFont(
                        <>
                          <span className={`${language === "en" ? "font-bold" : "font-semibold"}`}>{career.title[language]}</span> :{" "}
           ...
           >
            ...
            <ul className="space-y-1">
              {outcome.learning_description.map((description, index) => (
                ...
                >
                  {renderTextWithFont(
                    language === "en" ? `${description.text.en}` : `${description.text.en}`,
                    language, 
                    "body"
                  )}
                </li>
        ...
        >
         {renderTextWithFont(
          language === "en" ? "Learn More about the Admission Process " : "ស្វែងយល់បន្ថែមអំពីការចូលរៀន",
          language,
          "body"
        )}
