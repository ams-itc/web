    ...
    curriculum: {
      year1: {
        semester1: [
          ...
          {
            code: 'DTCI11ENV',
            name: { en: 'Environment', kh: 'បរិស្ថានវិទ្យា' },
            credit: 2,
          },
          {
            code: 'DTCI11FRA',
        ...
        semester2: [
          ...
          {
            code: 'DTCI12TMD',
            name: { en: 'Thermodynamics', kh: 'ទែម៉ូឌីណាមិច' },
            credit: 3,
          },
          {
            code: 'DTCI12MKT',
      ...
      year2: {
        semester1: [
          {
            code: 'DTCI21ELE',
            name: { en: 'Electricity', kh: 'អគ្គិសនី' },
            credit: 3,
          },
          {
            code: 'DTCI21ANL',
            name: { en: 'Calculus III', kh: 'គណិតវិទ្យាអនុវត្ត ភាគ​ ៣' },
            credit: 2.25,
          },
          {
            code: 'DTCI21DSP',
            name: {
              en: 'Data Structure and Programming I',
              kh: 'រចនាសម្ព័ន្ធទិន្នន័យ និង កម្មវិធី ភាគ​ ១',
            },
            credit: 3,
          },
          {
            code: 'DTCI21ALG',
            name: { en: 'Linear Algebra', kh: 'ពិជគណិតលីនេអ៊ែរ' },
            credit: 2.25,
          },
          {
            code: 'DTCI21ANG',
            name: { en: 'English', kh: 'ភាសាអង់គ្លេស' },
            credit: 2,
          },
          {
            code: 'DTCI21FRA',
        ...
        semester2: [
          {
            code: 'DTCI22PRO',
            name: { en: 'Probability', kh: 'ប្រូបាប៊ីលីតេ' },
            credit: 2.25,
          },
          {
            code: 'DTCI22EQD',
            name: { en: 'Differential Equations', kh: 'សមីការឌីផេរ៉ង់ស្យែល' },
            credit: 2.25,
          },
          {
            code: 'DTCI21DSP',
            name: { en: 'Data Structure and Programming II', kh: 'រចនាសម្ព័ន្ធទិន្នន័យ និង កម្មវិធី ភាគ​ ២' },
            credit: 3,
          },
          {
            code: 'DTCI22ACO',
            name: { en: 'Computer Architecture', kh: 'រចនាសម្ព័ន្ធកុំព្យូទ័រ' },
            credit: 3,
          },
          {
            code: 'DTCI22ANG',
      ...
      year3: {
        semester1: [
          ...
          {
            code: 'AMSI31OOP',
            name: { en: 'Object-Oriented Programming', kh: 'Object-Oriented Programming' },
            credit: 2,
          },
          {
            code: 'AMSI32CPD',
            name: { en: 'Computer Programming in Data Science', kh: 'កម្មវិធីកុំព្យូទ័រក្នុងវិទ្យាសាស្ត្រទិន្នន័យ' },
            credit: 2,
          },
          {
            code: 'AMSI31IDS',
            name: { en: 'Introduction to Data Science', kh: 'ការណែនាំអំពីវិទ្យាសាស្ត្រទិន្នន័យ' },
            credit: 2,
          },
          {
            code: 'AMSI31DIM',
            name: { en: 'Discrete Mathematics', kh: 'Discrete Mathematics' },
            credit: 2,
          },
          {
            code: 'AMSI31OPT',
            name: { en: 'Optimization', kh: 'Optimization' },
            credit: 2,
          }
        ],
        totalCredit: 15,
        semester2: [
          ...
          {
            code: 'AMSI32NUA',
            name: { en: 'Numerical Analysis ', kh: 'ការវិភាគ​ចំនួន' },
            credit: 3,
          },
          {
            code: 'AMSI32IML',
            name: { en: 'Introduction to Machine Learning', kh: 'ការណែនាំអំពី Machine Learning' },
            credit: 3,
          },
          {
            code: 'AMSI32DAT',
            name: { en: 'Database', kh: 'មូលដ្ឋានទិន្នន័យ' },
            credit: 2,
          },
          {
            code: 'AMSI31MAM',
            name: { en: 'Mathematical Modeling', kh: 'Mathematical Modeling' },
            credit: 2,
          },
          {
            code: 'AMSI32INN',
            name: { en: 'Introduction to Networks', kh: 'Introduction to Networks' },
            credit: 2,
          },
          {
            code: 'AMSI32INN',
          ...
          {
            code: 'AMSI32MIP',
            name: { en: 'Minor project', kh: 'Minor project' },
            credit: 1,
          }
        ],
        totalCredit2: 16,
