...
const programs: Record<ProgramKey, Program> = {
  master_datascience: {
    title: "Master of Engineering in Data Science",
  ...
  return (
    <div className="w-full">
      ...
      <h1 className="mt-4 text-xl text-black font-medium font-reddit_sans">
        Master of Engineering in <span className="text-[#C41E3A]">Data Science</span>
      </h1>
      ...
      <div className="max-w-6xl py-6">
              ...
              {Object.keys(program.curriculum).map((yearKey) => (
                <button
                  ...
                  className={`py-3 font-medium px-2 text-base border border-gray-300 font-reddit_sans ${
                    selectedYear === yearKey ? "bg-[#3A3B5C]/20 text-[#3A3B5C]" : "bg-[#D9D9D9]/50 text-[#3A3B5C]"
                  }`}
        ...
        >
         Apply Now <i className="fa-solid fa-arrow-right-long pl-3" ></i>
        </a>
      </div>
    </div>
  );
