    ...
    <footer className="w-full bg-[#3A3B5C] text-[#FFFFFF] font-raleway overflow-hidden py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Department Info */}
          <div>
            <h3 className={`text-xl font-medium mb-4 ${headingFont}`}>
              {footerItems.departmentName}
            </h3>
            <p className={`text-sm font-normal mb-6 leading-relaxed ${bodyFont}`}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerItems.quickLinks.map((link, index) => (
                <li key={index}>
                  <a href="#" className={`text-sm hover:underline ${bodyFont}`}>
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <a href="https://www.google.com/maps" className={`text-sm hover:underline ${bodyFont}`}>
              ...
              <div className="flex items-center">
                ...
                <p className={`text-sm ${bodyFont}`}>{footerItems.contact.phone}</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex flex-col text-sm space-y-1">
                  {footerItems.contact.emails.map((email, idx) => (
                    <a key={idx} href={`mailto:${email}`} className={`hover:underline ${bodyFont}`}>
                      {email}
                    </a>
                  ))}
                </div>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className={`text-base font-normal mb-4 md:mb-0 ${bodyFont}`}>
