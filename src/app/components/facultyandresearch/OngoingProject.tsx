                    ...
                    <AnimatePresence initial={false}>
                        ...
                        <div className="p-4 text-gray-700 font-raleway">
                            <div className="text-[#2E2E2E]/80">
                                <p className="mb-2"><strong>Project Timeline:</strong> {item.duration}</p>
                                ...
                                <p className="mb-2"><strong>Collaborative Partners:</strong> {item.funding}</p>
                                <p className="mb-2"><strong>Total Funding:</strong> {item.students}</p>
                                <p className="mb-2"><strong>Current Team:</strong> {item.students}</p>
                                <p className="mb-2"><strong>Industry Collaborators:</strong> {item.students}</p>
                            </div>
