...
export default function ResearchClubs() {
  ...
  return (
    <section className="bg-white py-10 flex flex-col items-center gap-y-5 w-full overflow-hidden">
      {/* Title */}
      ...
      <div className="relative w-full mx-auto overflow-hidden">
        ...
        >
          {clubs.map((club, idx) => (
            <SwiperSlide
              key={idx}
              className="transition-transform duration-300 h-auto min-h-[400px] min-w-auto content-start pb-3"
            >
              {({ isActive }) => (
                <div
        ...
        <div className="flex justify-center">
          <button className="bg-white text-indigo-900 px-4 py-2 rounded-full font-medium hover:bg-gray-100 transition">
            ...
            >
              ...
              <ArrowRight className="ml-2 w-4 md:w-6 lg:w-8" />
            </span>
          </button>
        </div>
      </div>
