...
export default function Contact() {
  ...
  return (
    <div className="w-full py-10 px-6 md:px-25">
      {/* Hero Section */}
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-black">
          {renderTextWithFont(language === "en" ? "Contact Us" : "ទំនាក់ទំនង", language, "heading")}
        </h1>
      ...
      <div className="container mx-auto px-6 lg:px-20 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12 w-full">
        ...
        <div className="col-span-2">
          <h2 className="text-3xl font-semibold text-black">
            {renderTextWithFont(language === "en" ? "Get in Touch" : "ទំនាក់ទំនងមកយើង", language, "heading")}
          </h2>
          <form className="space-y-6 mt-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
              <div>
                <label className="text-black text-lg font-semibold">
                  {renderTextWithFont(language === "en" ? "First Name" : "នាម", language, "body")}
                </label>
                <input
                  type="text"
                  placeholder={language === "en" ? "Enter your first name" : "បញ្ចូលនាម"}
                  className="w-full border bg-gray-100 rounded-lg p-3 focus:ring-2 focus:ring-indigo-500 text-gray-800"
                />
              </div>
              <div>
                <label className="text-black text-lg font-semibold">
                  {renderTextWithFont(language === "en" ? "Last Name" : "គោត្តនាម", language, "body")}
                </label>
                <input
                  type="text"
                  placeholder={language === "en" ? "Enter your last name" : "បញ្ចូលគោត្តនាម"}
                  className="w-full border bg-gray-100 rounded-lg p-3 focus:ring-2 focus:ring-indigo-500 text-gray-800"
                />
              </div>
            </div>
            ...
            <div>
              <label className="text-black text-lg font-semibold">
                {renderTextWithFont(language === "en" ? "Email" : "អ៊ីម៉ែល", language, "body")}
              </label>
              <input
                type="email"
                placeholder={language === "en" ? "Enter your email" : "បញ្ចូលអ៊ីម៉ែលរបស់អ្នក"}
                className="w-full border bg-gray-100 rounded-lg p-3 focus:ring-2 focus:ring-indigo-500 text-gray-800"
              />
            </div>
            ...
            <div>
              <label className="text-black text-lg font-semibold">
                {renderTextWithFont(language === "en" ? "Subject" : "ប្រធានបទ", language, "body")}
              </label>
              <input
                type="text"
                placeholder={language === "en" ? "Enter subject" : "បញ្ចូលប្រធានបទ"}
                className="w-full border bg-gray-100 rounded-lg p-3 focus:ring-2 focus:ring-indigo-500 text-gray-800"
              />
            </div>
            ...
            <div>
              <label className="text-black text-lg font-semibold">
                {renderTextWithFont(language === "en" ? "Message" : "សារ", language, "body")}
              </label>
              <textarea
                placeholder={language === "en" ? "Enter your message" : "បញ្ចូលសាររបស់អ្នក"}
            ...
            >
              {renderTextWithFont(language === "en" ? "Send Message" : "ផ្ញើសារ", language, "body")}
            </button>
          </form>
        </div>
        ...
        <div className="col-span-1 space-y-6">
          <h2 className="text-3xl font-semibold text-black">
            {renderTextWithFont(language === "en" ? "Contact Information" : "ព័ត៌មានទំនាក់ទំនង", language, "heading")}
          </h2>
          ...
          <div className="space-y-6 bg-white shadow-2xl rounded-xl p-6 border border-[#C41E3A] mt-10 border-l-8">
            <div className="flex items-start space-x-2">
              ...
              <div className="flex flex-col">
                <h4 className="text-lg text-[#2E2E2E] font-medium">
                  {renderTextWithFont(language === "en" ? "Address" : "អាសយដ្ឋាន", language, "body")}
                </h4>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="flex flex-col">
                <h4 className="text-lg text-[#2E2E2E] font-medium">
                  {renderTextWithFont(language === "en" ? "Phone" : "ទូរស័ព្ទ", language, "body")}
                </h4>
                <p className="text-xs text-gray-600">(+855) 12 999 310</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="flex flex-col">
                <h4 className="text-lg text-[#2E2E2E] font-medium">
                  {renderTextWithFont(language === "en" ? "Office Hours" : "ម៉ោងធ្វើការ", language, "body")}
                </h4>
                <p className="text-xs text-gray-600">
                  {renderTextWithFont(
                    language === "en"
          ...
          <div className="bg-gray-100 rounded-xl py-6 shadow-2xl border border-[#3A3B5C] border-l-8">
            <div className="px-5">
              <h3 className="text-xl font-medium mb-5 text-black inline-flex items-center gap-2">
                <Building size={25} />
                {renderTextWithFont(language === "en" ? "Visit Our Department" : "មកកាន់ដេប៉ាតឺម៉ង់របស់យើង", language, "heading")}
              </h3>
