        ...
        <div className="grid md:grid-cols-3 gap-x-6">
          ...
          <div className="space-y-4 mt-3 md:mt-1 lg:mt-0">
            ...
            {UpcomingEvents.map((event) => (
              <div key={event.id} className="rounded-xl space-y-4 transition">
                {/* Desktop / Large screens */}
                <div className="hidden md:flex">
                  <div className="bg-white shadow rounded-xl p-3 border border-gray-200 w-full">
                    <h1 className="text-[clamp(0.75rem,1.5vw,1rem)] text-black mb-1 font-semibold">
                      {renderTextWithFont(
                ...
                <div className="md:hidden">
                  <div className="bg-white shadow rounded-xl p-3 border border-gray-200 grid grid-cols-2 gap-x-1">
                    <div>
                      <h1 className="text-[clamp(0.75rem,2vw,1rem)] text-black mb-1 font-semibold">
                        {renderTextWithFont(
                          language === 'en' ? event.title.en : event.title.kh,
                          language,
                          'heading'
                      ...
                      <h2 className="text-[clamp(0.625rem,2vw,0.875rem)] mb-0.5 font-medium text-[#767676]">
                        {renderTextWithFont(
                          language === 'en'
                            ? event.speaker.en
                            : event.speaker.kh,
                    ...
                    <div className="text-gray-600 space-y-0.5">
                      <span className="inline-flex gap-1 items-center text-[clamp(0.625rem,2vw,0.875rem)] font-medium">
                        <CalendarDays size={12} />
                        {renderTextWithFont(
                          language === 'en' ? event.date.en : event.date.kh,
                          language,
                      ...
                      <p className="text-[clamp(0.5rem,2vw,0.875rem)] font-medium">
                        {renderTextWithFont(
                          language === 'en' ? event.time.en : event.time.kh,
                          language,
                          'body'
