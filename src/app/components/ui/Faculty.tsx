...
const facultyMembers = [
  {
    name: {
      en: 'Asst. Prof. Dr. PHAUK Sokkhey',
      kh: 'សាស្ត្រាចារ្យ ភោគ សុខខី',
    },
    position: { en: 'Head of Department', kh: 'ប្រធានដេប៉ាតឺម៉ង់' },
    specialization: {
      en: 'Mathematics and Data Science',
      kh: 'គណិតវិទ្យា និង វិទ្យាសាស្ត្រ​ទិន្នន័យ',
    },
    quote: {
                    ...
                    <div className="col-span-1 space-y-3">
                      ...
                      >
                        {language === 'en'
                          ? 'View Full Profile'
                          : 'ប្រវត្តិរូបពេញ'}{' '}
                        <ExternalLink className="h-3 md:h-4 lg:h-5" />
                      </a>
                    </div>
