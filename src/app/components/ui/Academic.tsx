...
const cards = [
  ...
  },
  {
    ...
    title: { en: "Master of Engineering ", kh: "បរិញ្ញាបត្រជាន់ខ្ពស់ វិស្វកម្ម " },
    highlight: { en: "Data Science", kh: "វិទ្យាសាស្ត្រ​ទិន្នន័យ" },
    description: {
    ...
    list: {
      en: ["Statistical theory", "Data science methods", "Machine learning", "Thesis research"],
      kh: ["ទ្រឹស្តីស្ថិតិសាស្ត្រ", "វិធីសាស្ត្រវិទ្យាសាស្ត្រ​ទិន្នន័យ", "ការសិក្សាម៉ាស៊ីន", "ស្រាវជ្រាវថេសី"],
    },
    ...
    <section className="bg-white px-8 md:px-20 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        {cards.map((card, index) => (
          <div
            key={index}
            className={`border-2 ${card.border} rounded-2xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300 p-8 flex flex-col justify-between`}
          >
            <div>
            ...
            <div className="mt-6 flex items-center justify-between text-sm border-t border-gray-400 pt-2">
              ...
              <a href="#" className="text-[#C41E3A] font-semibold hover:underline">
