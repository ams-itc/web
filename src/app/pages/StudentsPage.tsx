            ...
            <div className="w-full grid grid-cols-5 gap-x-2">
                <nav className="col-span-1 px-10 py-3 sticky top-0 h-screen overflow-y-auto">
                    <div className="py-8 border-b border-gray-300">
                        <a href="/students/#achievement" className="text-base text-black font-raleway">Student’s Achievement</a>
                    </div>
                    <div className="py-8 border-b border-gray-300">
                        <a href="/students/#activity" className="text-base text-black font-raleway">Student’s Life</a>
                    </div>
                    <div className="py-8 border-b border-gray-300">
                        <a href="/students/#resource" className="text-base text-black font-raleway">Student’s Resources</a>
                    </div>
                    <div className="py-8">
                        <a href="/students/#alumini" className="text-base text-black font-raleway">Alumni</a>
                    </div>
                </nav>
